...
file_names = convert_to_day(timestamps)  
"""
for file in files:
    ...
    file_name = convert_to_day(timestamp)
    ...
    def get_parameters(h):
        ...
        peak_parameters = (properties["right_bases"][0] / bins) / trim_factor, (
            properties["left_bases"][0] / bins
        ) * trim_factor
    ...
    def make_stats_dict(masked_img):
        ...
        hue_circular_mean = stats.circmean(
            h[np.where(h > 0)], high=179, low=0
        )  # low used to be 0
        ...
        stats_dict = {
            "median": hue_median,
            "mean": hue_circular_mean,
            "std": hue_circular_std,
            "range": hue_range,
            "hue_list": h,
            "counter": c,
        }
    ...
    def get_colour_dict(stats_dict):
        ...
        stats_dict["magenta"] = (
            total_colour(stats_dict["counter"], magenta) / total * 100
        )
    ...
    final_dict = clean_up(stats_dict, file_name)
